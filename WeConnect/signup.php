...
<div class="container-fluid">
	<form action="" id="create-account">
		...
		<div class="form-group">
			<label for="" class="control-label font-weight-light">Username</label>
		...
		<div class="form-group">
			...
			<input type="file" class="form-control bg-transparent" name="img" onchange="displayImg(this,$(this))">
		</div>
		<div class="form-group">
				<img src="" alt="" id="cimg">
		</div>
